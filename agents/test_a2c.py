...
# Load test data (last 20% of sideways regime)
...
test_df = sideways_df.iloc[int(0.8 * len(sideways_df)):].reset_index(drop=True)
...
# Load trained model
model = A2C.load("models/A2C/a2c_crypto_trader")
